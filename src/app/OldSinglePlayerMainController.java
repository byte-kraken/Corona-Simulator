 ...
 */
public class OldSinglePlayerMainController extends Controller {
    ...
    public OldSinglePlayerMainController() {
        super();
    }
    ...
    public void armVirus() { //Virus should maybe be an own class.
        ...
        nrInfectedLabel.setText(String.valueOf(globalModel.getNrInfected())); //placeholder
    }

    private void triggerInfect(Scene currentScene, Circle virus) {
        //TODO: Infection logic
        //placeholder
        if (!globalModel.isInfectionStarted()) {
            System.out.println("Starting infection.");
            globalModel.setInfectionStarted(true);
        }
        globalModel.setNrInfected(globalModel.getNrInfected() + 1);
        nrInfectedLabel.setText(String.valueOf(globalModel.getNrInfected()));
    }
